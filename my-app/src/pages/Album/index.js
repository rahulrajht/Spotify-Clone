...
function Album() {
    ...
    async function saveAlbum() {
        try {
            ...
            alert('There was an error saving the album.');
        }
    }
    ...
    async function removeAlbum() {
        try {
            ...
            alert('There was an error removing the album from your library.');
        }
    }
                        ...
                        <div className="album-info">
                            ...
                            <div className="album-year">
                                ...
                                {album.total_tracks === 1 && (
                                    <span>{album.total_tracks} music</span>
                                )}
                                {album.total_tracks > 1 && (
                                        ...
                                        onClick={() =>
                                            dispatch(
                                                Player.playTrack({
                                                    id: data.id,
                                                    name: data.name,
                                                    preview_url: data.uri ? data.uri :data.preview_url,
                                                    album: {
                                                        id: album.id,
                                                        images: album.images,
                                                    },
